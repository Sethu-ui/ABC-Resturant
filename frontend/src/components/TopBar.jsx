...
const Topbar = () => {
  ...
  return (
    <div className="navbar-custom" style={{ backgroundColor: '#9b9595' }}>
      <div className="topbar container-fluid">
        <div className="d-flex align-items-center gap-1">
          ...
          <button className="button-toggle-menu" style={{ color: '#000' }}>
        ...
        <ul className="topbar-menu d-flex align-items-center gap-3">
          <Link to="/dashboard/cart">
            <li className="d-none d-sm-inline-block">
              <div className="nav-link" id="cart-icon" style={{ color: '#000' }}>
                <i className="ri-shopping-cart-line fs-22"></i>
              </div>
            </li>
          </Link>
          <li className="d-none d-sm-inline-block">
            <div className="nav-link" id="light-dark-mode" style={{ color: '#000' }}>
          ...
          <li className="dropdown">
            ...
            >
              ...
              <span className="d-lg-block d-none">
                <h5 className="my-0 fw-normal" style={{ color: '#000' }}>
                  {firstName}{" "}
            ...
            <div className="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
              ...
              <div className="dropdown-header noti-title">
                <h6 className="text-overflow m-0" style={{ color: '#000' }}>Welcome !</h6>
              </div>

              {/* item */}
              <Link to="profile" className="dropdown-item" style={{ color: '#000' }}>
                <i className="ri-account-circle-line fs-18 align-middle me-1"></i>
                <span>My Account</span>
              </Link>
              {/* item */}
              <button onClick={handleLogout} className="dropdown-item" style={{ color: '#000' }}>
